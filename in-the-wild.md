...
|---|--:|---|---|
| [MODSetter/SurfSense](https://github.com/MODSetter/SurfSense) | 15,195★ | Scope index endpoint authorization | [#1503](https://github.com/MODSetter/SurfSense/pull/1503) |
| [miurla/morphic](https://github.com/miurla/morphic) | 8,961★ | Wrap `current_setting()` for per-statement eval | [#902](https://github.com/miurla/morphic/pull/902) |
| [JasperFx/marten](https://github.com/JasperFx/marten) | 3,423★ | Wrap `current_setting()` in the generated tenant policy (.NET) | [#4805](https://github.com/JasperFx/marten/pull/4805) |
| [gridaco/grida](https://github.com/gridaco/grida) | 2,553★ | Wrap `auth.uid()`, enable FORCE RLS | [issue](https://github.com/gridaco/grida/issues/873) · [#874](https://github.com/gridaco/grida/pull/874) |
| [crbnos/carbon](https://github.com/crbnos/carbon) | 2,245★ | Per-statement auth wrap (USING + WITH CHECK) | [issue](https://github.com/crbnos/carbon/issues/964) · [#965](https://github.com/crbnos/carbon/pull/965) |
...
| Project | ★ | What pgrls surfaced | Links |
|---|--:|---|---|
| [onlook-dev/onlook](https://github.com/onlook-dev/onlook) | 26,134★ | Wrap auth calls in RLS policies | [#3121](https://github.com/onlook-dev/onlook/pull/3121) |
| [Helicone/helicone](https://github.com/Helicone/helicone) | 5,913★ | Wrap auth calls for per-statement eval | [#5705](https://github.com/Helicone/helicone/pull/5705) |
| [archtechx/tenancy](https://github.com/archtechx/tenancy) | 4,370★ | Wrap `current_setting()` in the RLS PolicyManager codegen (Laravel) | [#1468](https://github.com/archtechx/tenancy/pull/1468) |
| [ruvnet/RuVector](https://github.com/ruvnet/RuVector) | 4,327★ | Wrap `current_setting()` in the tenancy RLS codegen (Rust) | [#639](https://github.com/ruvnet/RuVector/pull/639) |
...
| [firecrawl/open-scouts](https://github.com/firecrawl/open-scouts) | 1,306★ | Wrap `auth.uid()` | [issue](https://github.com/firecrawl/open-scouts/issues/12) · [#13](https://github.com/firecrawl/open-scouts/pull/13) |
| [lucasastorian/llmwiki](https://github.com/lucasastorian/llmwiki) | 1,294★ | Wrap `auth.uid()` | [issue](https://github.com/lucasastorian/llmwiki/issues/63) · [#64](https://github.com/lucasastorian/llmwiki/pull/64) |
...
| Project | ★ | What pgrls surfaced | Links |
|---|--:|---|---|
| [drizzle-team/drizzle-orm](https://github.com/drizzle-team/drizzle-orm) | 35,054★ | Add `.forceRLS()` to the pgTable builder | [issue](https://github.com/drizzle-team/drizzle-orm/issues/5819) · [#5843](https://github.com/drizzle-team/drizzle-orm/pull/5843) |
| [analysis-tools-dev/static-analysis](https://github.com/analysis-tools-dev/static-analysis) | 14,659★ | List pgrls | [#1829](https://github.com/analysis-tools-dev/static-analysis/pull/1829) |
| [dhamaniasad/awesome-postgres](https://github.com/dhamaniasad/awesome-postgres) | 11,980★ | List pgrls | [#514](https://github.com/dhamaniasad/awesome-postgres/pull/514) |
