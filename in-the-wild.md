...
|---|--:|---|---|
| [windmill-labs/windmill](https://github.com/windmill-labs/windmill) | 17,166★ | Wrap `current_setting('session.*')` reads across every RLS policy | [issue](https://github.com/windmill-labs/windmill/issues/10104) · [#10110](https://github.com/windmill-labs/windmill/pull/10110) |
| [MODSetter/SurfSense](https://github.com/MODSetter/SurfSense) | 15,263★ | Scope index endpoint authorization | [#1503](https://github.com/MODSetter/SurfSense/pull/1503) |
...
| Project | ★ | What pgrls surfaced | Links |
|---|--:|---|---|
| [onlook-dev/onlook](https://github.com/onlook-dev/onlook) | 26,203★ | Wrap auth calls in RLS policies | [#3121](https://github.com/onlook-dev/onlook/pull/3121) |
| [Helicone/helicone](https://github.com/Helicone/helicone) | 5,949★ | Wrap auth calls for per-statement eval | [#5705](https://github.com/Helicone/helicone/pull/5705) |
...
| [butterbase-ai/butterbase](https://github.com/butterbase-ai/butterbase) | 2,763★ | Wrap `current_setting('app.role')` in the service-role policies | [#88](https://github.com/butterbase-ai/butterbase/pull/88) |
...
| [lucasastorian/llmwiki](https://github.com/lucasastorian/llmwiki) | 1,366★ | Wrap `auth.uid()` | [issue](https://github.com/lucasastorian/llmwiki/issues/63) · [#64](https://github.com/lucasastorian/llmwiki/pull/64) |
...
| Project | ★ | What pgrls surfaced | Links |
|---|--:|---|---|
| [drizzle-team/drizzle-orm](https://github.com/drizzle-team/drizzle-orm) | 35,157★ | Add `.forceRLS()` to the pgTable builder | [issue](https://github.com/drizzle-team/drizzle-orm/issues/5819) · [#5843](https://github.com/drizzle-team/drizzle-orm/pull/5843) |
| [analysis-tools-dev/static-analysis](https://github.com/analysis-tools-dev/static-analysis) | 14,675★ | List pgrls | [#1829](https://github.com/analysis-tools-dev/static-analysis/pull/1829) |
| [dhamaniasad/awesome-postgres](https://github.com/dhamaniasad/awesome-postgres) | 11,993★ | List pgrls | [#514](https://github.com/dhamaniasad/awesome-postgres/pull/514) |
