...
|---|--:|---|---|
| [windmill-labs/windmill](https://github.com/windmill-labs/windmill) | 17,160★ | Wrap `current_setting('session.*')` reads across every RLS policy | [issue](https://github.com/windmill-labs/windmill/issues/10104) · [#10110](https://github.com/windmill-labs/windmill/pull/10110) |
| [MODSetter/SurfSense](https://github.com/MODSetter/SurfSense) | 15,257★ | Scope index endpoint authorization | [#1503](https://github.com/MODSetter/SurfSense/pull/1503) |
| [miurla/morphic](https://github.com/miurla/morphic) | 8,978★ | Wrap `current_setting()` for per-statement eval | [#902](https://github.com/miurla/morphic/pull/902) |
...
| [gridaco/grida](https://github.com/gridaco/grida) | 2,559★ | Wrap `auth.uid()`, enable FORCE RLS | [issue](https://github.com/gridaco/grida/issues/873) · [#874](https://github.com/gridaco/grida/pull/874) |
| [crbnos/carbon](https://github.com/crbnos/carbon) | 2,261★ | Per-statement auth wrap (USING + WITH CHECK) | [issue](https://github.com/crbnos/carbon/issues/964) · [#965](https://github.com/crbnos/carbon/pull/965) |
...
| Project | ★ | What pgrls surfaced | Links |
|---|--:|---|---|
| [onlook-dev/onlook](https://github.com/onlook-dev/onlook) | 26,192★ | Wrap auth calls in RLS policies | [#3121](https://github.com/onlook-dev/onlook/pull/3121) |
| [Helicone/helicone](https://github.com/Helicone/helicone) | 5,948★ | Wrap auth calls for per-statement eval | [#5705](https://github.com/Helicone/helicone/pull/5705) |
...
| [butterbase-ai/butterbase](https://github.com/butterbase-ai/butterbase) | 2,745★ | Wrap `current_setting('app.role')` in the service-role policies | [#88](https://github.com/butterbase-ai/butterbase/pull/88) |
...
| [lucasastorian/llmwiki](https://github.com/lucasastorian/llmwiki) | 1,361★ | Wrap `auth.uid()` | [issue](https://github.com/lucasastorian/llmwiki/issues/63) · [#64](https://github.com/lucasastorian/llmwiki/pull/64) |
| [firecrawl/open-scouts](https://github.com/firecrawl/open-scouts) | 1,329★ | Wrap `auth.uid()` | [issue](https://github.com/firecrawl/open-scouts/issues/12) · [#13](https://github.com/firecrawl/open-scouts/pull/13) |
...
| Project | ★ | What pgrls surfaced | Links |
|---|--:|---|---|
| [drizzle-team/drizzle-orm](https://github.com/drizzle-team/drizzle-orm) | 35,155★ | Add `.forceRLS()` to the pgTable builder | [issue](https://github.com/drizzle-team/drizzle-orm/issues/5819) · [#5843](https://github.com/drizzle-team/drizzle-orm/pull/5843) |
| [analysis-tools-dev/static-analysis](https://github.com/analysis-tools-dev/static-analysis) | 14,674★ | List pgrls | [#1829](https://github.com/analysis-tools-dev/static-analysis/pull/1829) |
| [dhamaniasad/awesome-postgres](https://github.com/dhamaniasad/awesome-postgres) | 11,991★ | List pgrls | [#514](https://github.com/dhamaniasad/awesome-postgres/pull/514) |
