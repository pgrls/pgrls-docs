...
|---|--:|---|---|
| [MODSetter/SurfSense](https://github.com/MODSetter/SurfSense) | 15,223★ | Scope index endpoint authorization | [#1503](https://github.com/MODSetter/SurfSense/pull/1503) |
| [miurla/morphic](https://github.com/miurla/morphic) | 8,966★ | Wrap `current_setting()` for per-statement eval | [#902](https://github.com/miurla/morphic/pull/902) |
| [ruvnet/RuVector](https://github.com/ruvnet/RuVector) | 4,349★ | Wrap `current_setting()` in the tenancy RLS codegen (Rust) | [#639](https://github.com/ruvnet/RuVector/pull/639) |
| [JasperFx/marten](https://github.com/JasperFx/marten) | 3,426★ | Wrap `current_setting()` in the generated tenant policy (.NET) | [#4805](https://github.com/JasperFx/marten/pull/4805) |
...
| [crbnos/carbon](https://github.com/crbnos/carbon) | 2,253★ | Per-statement auth wrap (USING + WITH CHECK) | [issue](https://github.com/crbnos/carbon/issues/964) · [#965](https://github.com/crbnos/carbon/pull/965) |
| [moyangzhan/langchain4j-aideepin](https://github.com/moyangzhan/langchain4j-aideepin) | 1,324★ | Fix cross-user knowledge-base read | [issue](https://github.com/moyangzhan/langchain4j-aideepin/issues/104) · [#105](https://github.com/moyangzhan/langchain4j-aideepin/pull/105) |
...
| Project | ★ | What pgrls surfaced | Links |
|---|--:|---|---|
| [onlook-dev/onlook](https://github.com/onlook-dev/onlook) | 26,175★ | Wrap auth calls in RLS policies | [#3121](https://github.com/onlook-dev/onlook/pull/3121) |
| [Helicone/helicone](https://github.com/Helicone/helicone) | 5,936★ | Wrap auth calls for per-statement eval | [#5705](https://github.com/Helicone/helicone/pull/5705) |
| [archtechx/tenancy](https://github.com/archtechx/tenancy) | 4,372★ | Wrap `current_setting()` in the RLS PolicyManager codegen (Laravel) | [#1468](https://github.com/archtechx/tenancy/pull/1468) |
...
| [lucasastorian/llmwiki](https://github.com/lucasastorian/llmwiki) | 1,336★ | Wrap `auth.uid()` | [issue](https://github.com/lucasastorian/llmwiki/issues/63) · [#64](https://github.com/lucasastorian/llmwiki/pull/64) |
...
| Project | ★ | What pgrls surfaced | Links |
|---|--:|---|---|
| [drizzle-team/drizzle-orm](https://github.com/drizzle-team/drizzle-orm) | 35,117★ | Add `.forceRLS()` to the pgTable builder | [issue](https://github.com/drizzle-team/drizzle-orm/issues/5819) · [#5843](https://github.com/drizzle-team/drizzle-orm/pull/5843) |
| [analysis-tools-dev/static-analysis](https://github.com/analysis-tools-dev/static-analysis) | 14,669★ | List pgrls | [#1829](https://github.com/analysis-tools-dev/static-analysis/pull/1829) |
| [dhamaniasad/awesome-postgres](https://github.com/dhamaniasad/awesome-postgres) | 11,987★ | List pgrls | [#514](https://github.com/dhamaniasad/awesome-postgres/pull/514) |
| [supabase/splinter](https://github.com/supabase/splinter) | 251★ | Propose a lint for inverted-auth read policies | [issue](https://github.com/supabase/splinter/issues/165) · [#169](https://github.com/supabase/splinter/pull/169) |
